...
menu_options = ['Introduction','Information','Penetapan Kadar Cl %(b/v)']
selected_menu = st.sidebar.radio('Home',menu_options)
...
if (selected_menu == 'Information') :
    ...
    gambar = Image.open('rumus.png')
    
    st.image(gambar)

if (selected_menu == 'Penetapan Kadar Cl %(b/v)') :
